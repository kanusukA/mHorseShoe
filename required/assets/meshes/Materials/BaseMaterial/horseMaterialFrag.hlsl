...
uniform SAMPLER2D(p_heightMap, 1);
uniform SAMPLER2D(p_diffuseMap, 2);
uniform SAMPLER2D(p_normalMap,3);
uniform SAMPLER2D(p_metallicMap, 4);
uniform SAMPLER2D(p_smoothnessMap, 5);
uniform SAMPLER2D(p_edgeMap, 6);
uniform SAMPLER2D(p_AOMap, 7);
